...
class CheckStep1TermsPage extends ConsumerStatefulWidget {
  final int cardId;
  const CheckStep1TermsPage({super.key, required this.cardId});

  @override
  ConsumerState<CheckStep1TermsPage> createState() => _CheckStep1TermsPageState();
}

class _CheckStep1TermsPageState extends ConsumerState<CheckStep1TermsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ApplicationStepIndicator(currentStep: 1, totalSteps: 4),
                ...
                children: [
                  Icon(
                    ...
                    color: !_reachedBottom
                        ? AppColors.gray200
                        : (widget.agreed ? AppColors.teal600 : AppColors.gray400),
                    size: 20,
                  ),
                  const SizedBox(width: 8),
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: _reachedBottom ? AppColors.gray800 : AppColors.gray400,
                    ),
                  ),
